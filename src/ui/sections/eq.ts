...
export const eqSection: WorkspaceSectionModule = {
  ...
  content(snapshot) {
    ...
    return `
      <section class="panel control-panel" aria-label="Studio EQ">
        ...
        <div class="control-list eq-controls">
          ${dbControl(
            ...
            'Low',
            controls.lowShelfDb,
            AMP_CONTROL_DEFINITIONS.lowShelfDb,
            'Broad shelf fixed at 120 Hz.',
          )}
          ...
          ${unitControl(
            ...
            'Hz',
            'Choose the center of the lower-mid band.',
          )}
          ...
          ${dbControl(
            ...
            'Low Mid',
            controls.lowMidDb,
            AMP_CONTROL_DEFINITIONS.lowMidDb,
            'Cut mud or add body around the selected frequency.',
          )}
          ...
          ${unitControl(
            ...
            'Hz',
            'Choose the center of the upper-mid band.',
          )}
          ...
          ${dbControl(
            ...
            'Upper Mid',
            controls.upperMidDb,
            AMP_CONTROL_DEFINITIONS.upperMidDb,
            'Shape presence around the selected frequency.',
          )}

          ${dbControl(
            'high-shelf',
            'High',
            controls.highShelfDb,
            AMP_CONTROL_DEFINITIONS.highShelfDb,
            'Broad shelf fixed at 3.2 kHz.',
          )}
        </div>
      </section>
    `;
  ...
  bind(runtime) {
    ...
    // EQ enable toggle
    runtime.root
      .querySelector<HTMLInputElement>('#eq-enabled')
