...
| Fender Spring | Tone, Dwell | Decay |
| Polytone Spring | Tone, Decay | Low Cut |
...
| `fender-spring` | Three bright, dispersive chirp-echo paths with a splashy onset | 2.2 s |
| `polytone-spring` | Three darker chirp-echo paths with a shorter, restrained decay | 1.3 s |
...
The spring voices are approximations inspired by their names, not measured Fender/Polytone tanks or circuit models. Fender Dwell blends a clean send with a level-dependent, soft-saturating WaveShaper using 4× oversampling. At 0% no drive nodes exist; increasing Dwell changes harmonics and dynamics rather than duplicating Amount. It is not a physical tank-driver or mechanical-crash simulation.
