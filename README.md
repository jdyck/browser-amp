...
Amp and reverb selection share [stage switching](docs/audio-stage-switching.md): unused paths are retired after a fade, and bypassed reverb has no live convolver. EQ and Compression retain their existing bypass behavior.
